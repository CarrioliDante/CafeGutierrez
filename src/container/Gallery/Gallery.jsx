...
const Gallery = () => {
  ...
  /*La funcion scroll recibe un string "direction"
  en caso de ser Left se movera a la izquierda, 
  en caso contrario lo hara a la derecha*/
  const scroll = (direction) => {
    const {current} = scrollRef;
    //El estado actual es el de la galeria, definido con scrollRef
    if (direction === "left") {
